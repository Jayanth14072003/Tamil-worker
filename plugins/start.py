    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            if bool(CUSTOM_CAPTION) & bool(msg.document):
                caption = CUSTOM_CAPTION.format(filename = msg.document.file_name)
            else:
            ...
            try:
                na = await msg.copy(chat_id=message.from_user.id, caption = f"hi {msg.document.file_name}", parse_mode = ParseMode.HTML, reply_markup = reply_markup, protect_content=PROTECT_CONTENT)
